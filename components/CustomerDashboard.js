...
const CustomerDashboard = ({ onBack, onNavigate }) => {
  ...
  const handleButtonPress = (buttonType) => {
    ...
    Animated.sequence([
      Animated.timing(buttonAnimations[buttonType], {
        toValue: 1,
        duration: 150,
  ...
  const dashboardButtons = [
    {
      id: 'bookTanker',
      title: 'Book Tanker',
      subtitle: 'Schedule a water tanker delivery',
      icon: TruckIcon,
      color: '#D4AF37',
    },
    {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        {dashboardButtons.map((button) => {
          ...
          const scaleValue = buttonAnimations[button.id].interpolate({
            inputRange: [0, 1],
            outputRange: [1, 0.95],
          });
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          Choose an option to get started with your water tanker service
        </Text>
      </View>
    </SafeAreaView>
  );
