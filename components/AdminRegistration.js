...
const AdminRegistration = ({ onBack, onRegister }) => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Registration Failed',
        'There was an error creating your admin account. Please try again.',
        [{ text: 'OK' }]
      );
    } finally {
      setIsLoading(false);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.formContainer}>
          ...
          >
            {isLoading ? (
              <Text style={styles.registerButtonText}>Creating Admin Account...</Text>
            ) : (
              <>
