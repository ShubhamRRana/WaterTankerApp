...
type Props = {
  onBack: () => void;
  onLogin: (role: 'customer', credentials: { phoneNumber: string; password: string }) => void;
  onCreateAccount?: () => void;
};

const CustomerLogin = ({ onBack, onLogin, onCreateAccount }: Props): React.ReactElement => {
...
const styles = StyleSheet.create({
  ...
  createAccountButton: { backgroundColor: 'transparent', borderWidth: 1, borderColor: '#D4AF37', borderRadius: 12, paddingVertical: 16, alignItems: 'center', marginTop: 12 },
  createAccountButtonText: { fontSize: 16, fontWeight: '600', color: '#D4AF37' },
